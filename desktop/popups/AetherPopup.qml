...
CardWindow {
    ...
    readonly property string hintText: aetherPopup.wallhavenMode
    ...
    Column {
        ...
        PopupHeader {
            ...
            title: "AETHER"
            subtitle: aetherPopup.statusText
            rightContent: CalendarChevron {
