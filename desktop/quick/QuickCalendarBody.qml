    ...
    Column {
        ...
        Item {
            ...
            Text {
                ...
                text: (body.shell ? body.shell.calendarMonthName : "")
                      + "  ·  " + (body.shell ? body.shell.calendarYear : "")
                color: body.root.ink
            ...
            Row {
                ...
                CalendarChevron {
                    ...
                    onTriggered: {
                        ...
                        body.shell.calendarMonthOffset--;
                        body.shell.calendarTick++;
                        body.shell.selectedDay = 0;
                    }
                }
                CalendarChevron {
                    root: body.root
                    ...
                    onTriggered: {
                        if (!body.shell) return;
                        body.shell.calendarMonthOffset = 0;
                        body.shell.calendarTick++;
                        body.shell.selectedDay = (new Date()).getDate();
                    }
                }
                CalendarChevron {
                    root: body.root
        ...
        Grid {
            ...
            width: parent.width
            Repeater {
                model: body.shell ? body.shell.calendarCells : []
                delegate: Item {
                    id: dayCell
                    ...
                    MouseArea {
                        ...
                        onClicked: if (body.shell) body.shell.selectedDay = dayCell.modelData.day
                    }
                }
            }
        }
